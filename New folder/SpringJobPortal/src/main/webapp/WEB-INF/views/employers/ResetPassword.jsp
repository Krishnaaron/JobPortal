        ...
        <div>
            ...
            <div>
                <a href="cart" class="nav_link ">
                    ...
                    <a href="EployerPasswordController" class="nav_link active">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="password-reset-form" action="employerPasswordRestController">
                        <input type="hidden" name="emp_Id" value="${employers.id}">
