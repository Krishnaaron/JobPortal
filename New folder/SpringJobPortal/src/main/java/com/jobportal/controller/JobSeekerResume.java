...
public class JobSeekerResume
{
	...
	//
	// public String createJobSeekerProfile(@RequestParam("dob") String dob,
	// @RequestParam("gender") String gender,
	// @RequestParam("JOB_SEEKER_ID") int JOB_SEEKER_ID,
	// @RequestParam("address") String address,
	// @RequestParam("course") String course, @RequestParam("specialization")
	// String specialization,
	// @RequestParam("institute") String institute, @RequestParam("passingYear")
	// String passingYear,
	// @RequestParam("cgpa") String cgpa, @RequestParam("courseType") String
	// courseType,
	// @RequestParam("experience") String experience,
	// @RequestParam("company_Name") String companyName,
	// @RequestParam("objective") String objective, @RequestParam("skills")
	// String skills,
	...
	public String createJobSeekerProfile(@RequestParam("dob") String dob, @RequestParam("gender") String gender, @RequestParam("JOB_SEEKER_ID") int JOB_SEEKER_ID,
			@RequestParam("address") String address, @RequestParam("course") String course, @RequestParam("specialization") String specialization,
			@RequestParam("institute") String institute, @RequestParam("passingYear") String passingYear, @RequestParam("cgpa") String cgpa,
			@RequestParam("courseType") String courseType, @RequestParam("experience") String experience, @RequestParam("company_Name") String companyName,
			@RequestParam("objective") String objective, @RequestParam("skills") String skills, @RequestParam("resumes") String resumes,
			@RequestParam("resume") MultipartFile resumeFile, RedirectAttributes redirectAttributes)
	{
	...
	public String jobSeekerProfileEdite(@RequestParam("fName") String fName, @RequestParam("email") String email, @RequestParam("dob") String dob,
			@RequestParam("gender") String gender, @RequestParam("JOB_SEEKER_ID") int JOB_SEEKER_ID, @RequestParam("address") String address, @RequestParam("course") String course,
			@RequestParam("specialization") String specialization, @RequestParam("institute") String institute, @RequestParam("passingYear") String passingYear,
			@RequestParam("cgpa") String cgpa, @RequestParam("course_Type") String courseType, @RequestParam("experience") String experience,
			@RequestParam("company_Name") String companyName, @RequestParam("objective") String objective, @RequestParam("resumes") String resumes,
